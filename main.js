      ...
      success : function (response) {
        viheralueet = L.geoJson(response, {
          style: function (feature) {
            ...
            if ( kaytto.indexOf("semakaavoitettu") > -1) fillColor = "#3333cc";
            else if ( kaytto == "Yleiskaavan viheralue" ) fillColor = "#663399";
            else if ( kaytto == "Ulkoilumetsä" ) fillColor = "#0099cc";
            ...
            else if ( kaytto == "Luonnonsuojelualue" ) fillColor = "#00cccc";
            else if ( kaytto.indexOf("luonnonsuojelualue") > -1 ) fillColor = "#6666cc";
            else if ( kaytto == "Uimaranta-alue" || kaytto == "Venesatama / Venevalkama" ) fillColor = "#cc0099";
            else if ( kaytto.indexOf("Haudat") > -1 ) fillColor = "#006666";
            else if ( kaytto == "Muut viheralueet" ) fillColor = "#000066";
